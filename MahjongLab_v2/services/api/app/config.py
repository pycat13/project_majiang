...
class Settings:
    ...
    mahjong_ai_root: Path = workspace_root / "Mahjong-AI"
    mahjong_ai_python: Path = mahjong_ai_root / ".venv" / "Scripts" / "python.exe"
    mahjong_ai_websockify: Path = mahjong_ai_root / ".venv" / "Scripts" / "websockify.exe"
    mahjong_ai_server_host: str = "127.0.0.1"
    mahjong_ai_server_port: int = 9999
    mahjong_ai_websocket_port: int = 8888
    mahjong_ai_web_port: int = 8080
